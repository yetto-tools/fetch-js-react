...
import {FcFactory, FcBusinessContact, FcConferenceCall, FcSimCardChip, FcDocument, FcContacts, FcCalendar, FcLeave} from 'react-icons/fc'
        ...
        '>
          <div className='text-black/50' >
            <button className='my-2 p-2 bg-white bg-opacity-60 rounded-lg border border-black/50 text-black/60 
               hover:text-black/80 hover:border-black/70 hover:backdrop-brightness-200 hover:font-bold duration-150 cursor-pointer
            ...
            <ul className='overflow-x-hidden '>
              <li className='my-2 bg-white bg-opacity-60 rounded-lg border border-black/50 text-black/60 
                transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-100 hover:text-black/80 hover:border-black/70 hover:backdrop-brightness-200 hover:font-bold duration-150 cursor-pointer
              '>
                <div className='inline-flex p-2' >
                  {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
                  </svg> */}
                  <FcFactory className='w-6 h-6'/>
              ...
              '>
                <div className='inline-flex p-2'>
                  ...
                  <FcSimCardChip className='w-6 h-6'/>
              ...
              '>
                <div className='inline-flex p-2'>
                  ...
                  <div className={`w-0 pl-2 ${ishidden}`}>Contactos</div>
                </div>
              </li>
              <li className='my-2 bg-white bg-opacity-60 rounded-lg border border-black/50 text-black/60 
                transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-100 hover:text-black/80 hover:border-black/70 hover:backdrop-brightness-200 hover:font-bold duration-150 cursor-pointer
              '>
                <div className='inline-flex p-2'>
                  <FcLeave className='w-6 h-6'/>
                  <div className={`w-0 pl-2 ${ishidden}`}>Calendario</div>
                </div>
              </li>
            </ul>
          </div>
