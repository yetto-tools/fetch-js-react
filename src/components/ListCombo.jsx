...
export default function ListCombo({itemList,setReturnSelected, displayName}) {
  const [selected, setSelected] = useState(itemList[0])
  
  useEffect(()=>{
    console.log('Lisbox param itemlist', itemList, typeof(itemList))
    setReturnSelected(selected)
  },[selected])
  return (
    <div className="fixed top-16 w-80">
